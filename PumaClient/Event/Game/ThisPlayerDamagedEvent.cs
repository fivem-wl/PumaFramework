...
public class ThisPlayerDamagedEvent : EntityDamageSubEvent
{
	public readonly Player Victim;


	public ThisPlayerDamagedEvent(NetworkEntityDamageEvent source) : base(source)
	{
		Victim = CitizenFX.Core.Game.Player;
	}
