...
{
	public class EntityKillEntityEvent : GameEvent
	{
		...
		public EntityKillEntityEvent(Entity attacker, Entity victim, uint weaponInfoHash, bool isMelee, int damageType)
		{
			Attacker = attacker;
			Victim = victim;
