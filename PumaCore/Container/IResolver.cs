...
public interface IResolver
{
	...
	bool UnregisterReference(object key = null, params Type[] types);
	
	bool UnregisterReferences(params Type[] types);

	object ResolveReference(Type type, object key = null); 
}
